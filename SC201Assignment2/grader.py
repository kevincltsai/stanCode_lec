...
File: grader.py
-----------------------------
Milestone 4 answer: TODO: the training error decreases, but validation error doesn't. It's overfitting.

#70 Official: train error = 0.014631401238041642, validation error = 0.26139561057962857
#80 Official: train error = 0.012380416432189083, validation error = 0.263083849184018
#90 Official: train error = 0.009566685424873381, validation error = 0.2658975801913337
...
# WordFeature : Official: train error = 0.03601575689364097, validation error = 0.26730444569499157
# CharFeature : Official: train error = 0.3545301069217783, validation error = 0.41783905458638154

# Word extraction is overfitting, the error difference between training and validation nearly 7times.(0.26/0.04)
# whereas charfeature is only 1.2 times. Hence CharFeature gives better prediction on unseen data.
