"""
File: titanic_bagging_classifier.py
Name: 
---------------------------
This file shows how to use pandas and sklearn ensemble
packages to build a simple classification model
by bagging technique
"""
...
def main():
    ...
    # Construct Bagging Classifier
    ###################
    #                 #
    #     :TODO       #
    #                 #
    ###################
    bagging = ensemble.BaggingClassifier(base_estimator= tree.DecisionTreeClassifier(max_depth=5, min_samples_leaf=6))
    bagging_classifier = bagging.fit(x_train,y)
    print('Traing Accc: ', bagging.score(x_train, y))
    ...
    # Make predictions by your bagging classifier
    ###################
    #                 #
    #     :TODO       #
    #                 #
